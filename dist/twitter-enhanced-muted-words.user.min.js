...
#currentBlockedWordsTable th:last-of-type,
...
;// CONCATENATED MODULE: ./src/managers/LocalStoreManager.ts
var LocalStoreManager_decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
let LocalStoreManager = class LocalStoreManager {
    constructor() {
...
LocalStoreManager = LocalStoreManager_decorate([
...
const timelineWrapperSelector = "[aria-label*='Home Timeline'] > div[style^='position: relative']";
function toggleHide(hide, element) {
    hide ? element.classList.add("hidden") : element.classList.remove("hidden");
}

;// CONCATENATED MODULE: ./src/UiBuilder.ts
var UiBuilder_decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var UiBuilder_metadata = (undefined && undefined.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};



let UiBuilder = class UiBuilder {
    constructor(localStoreManager) {
...
UiBuilder = UiBuilder_decorate([
    decorators_singleton(),
    UiBuilder_metadata("design:paramtypes", [LocalStoreManager])
], UiBuilder);


;// CONCATENATED MODULE: ./src/decorators/PostConstruct.ts
...
function PostConstruct(target, propertyKey, descriptor) {
    dependency_container_instance.afterResolution(target.constructor, (token, result) => {
...
;// CONCATENATED MODULE: ./src/TwitterMutator.ts
var TwitterMutator_decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var TwitterMutator_metadata = (undefined && undefined.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
let TwitterMutator = class TwitterMutator {
    constructor() {
    ...
    addObserver(context, type, method) {
        const obj = {
            method,
            context,
        };
    ...
    async onTimelinePost() {
        ...
        this.observerProxy = new MutationObserver((mutations, observer) => {
            ...
            for (const observable of observables) {
                const instance = dependency_container_instance.resolve(observable.context);
...
TwitterMutator_decorate([
    PostConstruct,
    TwitterMutator_metadata("design:type", Function),
    TwitterMutator_metadata("design:paramtypes", []),
    TwitterMutator_metadata("design:returntype", Promise)
], TwitterMutator.prototype, "init", null);
TwitterMutator = TwitterMutator_decorate([
    decorators_singleton()
], TwitterMutator);


;// CONCATENATED MODULE: ./src/decorators/TwitterPostEvent.ts


var TwitterPostType;
(function (TwitterPostType) {
    TwitterPostType[TwitterPostType["TIMELINE"] = 0] = "TIMELINE";
    TwitterPostType[TwitterPostType["POST"] = 1] = "POST";
})(TwitterPostType || (TwitterPostType = {}));
function TwitterPostEvent(type) {
    return function (target, propertyKey, descriptor) {
        const constructor = target.constructor;
        const mutatorProxy = dependency_container_instance.resolve(TwitterMutator);
        const method = target[propertyKey];
        mutatorProxy.addObserver(constructor, type, method);
    };
}

;// CONCATENATED MODULE: ./src/PageInterceptor.ts
var PageInterceptor_decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
};
var PageInterceptor_metadata = (undefined && undefined.__metadata) || function (k, v) {
    if (typeof Reflect === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(k, v);
};
...
PageInterceptor_decorate([
    PostConstruct,
    PageInterceptor_metadata("design:type", Function),
    PageInterceptor_metadata("design:paramtypes", []),
    PageInterceptor_metadata("design:returntype", void 0)
], PageInterceptor.prototype, "init", null);
PageInterceptor = PageInterceptor_decorate([
    decorators_singleton(),
    PageInterceptor_metadata("design:paramtypes", [])
], PageInterceptor);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/css/modal.css
var modal = __webpack_require__(108);
;// CONCATENATED MODULE: ./src/css/modal.css
...
var update = injectStylesIntoStyleTag_default()(modal/* default */.A, options);
       ...
       /* harmony default export */ const css_modal = (modal/* default */.A && modal/* default */.A.locals ? modal/* default */.A.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./src/css/switch.css
var css_switch = __webpack_require__(107);
;// CONCATENATED MODULE: ./src/css/switch.css
...
var switch_update = injectStylesIntoStyleTag_default()(css_switch/* default */.A, switch_options);




       /* harmony default export */ const src_css_switch = (css_switch/* default */.A && css_switch/* default */.A.locals ? css_switch/* default */.A.locals : undefined);
...
let TwitterPostObserver = class TwitterPostObserver {
    constructor(uiBuilder, localStoreManager, twitterMutator) {
        this.uiBuilder = uiBuilder;
        this.localStoreManager = localStoreManager;
        this.twitterMutator = twitterMutator;
    }
    removeElm(elms) {
    ...
    isTextBlocked(tweetText, allBlockedWords) {
    ...
    async init() {
        const location = window.location.pathname.split("/").pop();
        const pageInterceptor = dependency_container_instance.resolve(PageInterceptor);
...
Main_decorate([
    ...
    Main_metadata("design:paramtypes", [Array, MutationObserver]),
    Main_metadata("design:returntype", Promise)
], TwitterPostObserver.prototype, "processTimelinePost", null);
Main_decorate([
    PostConstruct,
    Main_metadata("design:type", Function),
    Main_metadata("design:paramtypes", []),
    Main_metadata("design:returntype", Promise)
], TwitterPostObserver.prototype, "init", null);
TwitterPostObserver = Main_decorate([
    decorators_singleton(),
    Main_metadata("design:paramtypes", [UiBuilder,
        LocalStoreManager,
        TwitterMutator])
], TwitterPostObserver);
dependency_container_instance.resolve(TwitterPostObserver);
